...
export interface Comic {
  ...
  viewed_chap: number;
  deleted: boolean;
  cover_visible?: boolean | undefined;
}
...
export const Comic: MessageFns<Comic> = {
  encode(message: Comic, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.cover_visible !== undefined) {
      writer.uint32(128).bool(message.cover_visible);
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 16: {
          ...
          message.cover_visible = reader.bool();
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): Comic {
    return {
      ...
      cover_visible: isSet(object.cover_visible) ? globalThis.Boolean(object.cover_visible) : undefined,
    };
  },
  ...
  toJSON(message: Comic): unknown {
    ...
    if (message.cover_visible !== undefined) {
      obj.cover_visible = message.cover_visible;
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<Comic>, I>>(object: I): Comic {
    ...
    message.cover_visible = object.cover_visible ?? undefined;
    return message;
  },
};
